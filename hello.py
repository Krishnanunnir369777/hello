...
dataset_name = 'Mountain'
threshold = 0.97

# Load images
file_path = os.path.join('Image Stitching Project', 'Dataset', dataset_name, '*.jpg')
...
if error == cv2.Stitcher_OK:
    ...
    result_folder = os.path.join('Image Stitching Project', 'Result', dataset_name)
